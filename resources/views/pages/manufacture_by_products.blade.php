            ...
            <div class="product-image-wrapper">
                <div class="single-products">
                        <div class="productinfo text-center">
                            <img src="{{URL::to($v_product_by_manufacture->product_image)}}" style="height: 200px; width: 210px;"alt="" />
                ...
                <div class="choose">
                    <ul class="nav nav-pills nav-justified">
                        <li><a href="{{URL::to('/view_product/'.$v_product_by_manufacture->product_id)}}"><i class="fa fa-plus-square"></i>{{$v_product_by_manufacture->product_name}}</a></li>
