						...
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<?php } else { ?>
									...
									<li><a href="{{URL::to('/login-checkout')}}"><i ></i> Checkout</a></li>
								<?php } ?>
								...
								<li><a href="{{URL::to('/do-contact')}}">Contact</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-3">
					...
					<div class="left-sidebar">
						...
						<div class="brands_products"><!--brands_products-->
							...
							<div class="brands-name">
								...
								<div class="panel panel-default">
									<div class="panel-heading">
										<h4 class="panel-title"><a href="{{URL::to('/product_by_manufacture/'.$v_manufacture->manufacture_id)}}">{{$v_manufacture-> manufacture_name}}</a></h4>
									</div>
								</div>
